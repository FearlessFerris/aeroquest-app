        ...
        try {
            ...
            if (existingBookmark) {
                ...
                setItemInfo((prevInfo) => ({
                    ...prevInfo,
                    toggleSuccessMessage: true,
                    successMessage: `Bookmark with AirlineID: ${itemInfo.chosenItem.id} was successfully updated!`,
                    toggleNotes: false,
                    notes: '',
                    actionType: 'updated'
                }));
                ...
                setItemInfo(( prevInfo ) => ({
                    ...prevInfo,
                    toggleSuccessMessage: true,
                    successMessage: `Bookmark successfully added for AirlineID: ${ response.data.bookmark.id }`,
